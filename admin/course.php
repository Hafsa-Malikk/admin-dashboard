    ...
    <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
      <div class="ms-md-auto pe-md-3 d-flex align-items-center w-40">
        <div class="input-group">
          ...
          <input type="text" class="form-control" id="searchCourse" placeholder="Search by Course Name...">
        </div>
      </div>
              ...
              <tbody>
                ...
                if ($result) {
                  while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<tr>';
                    echo '<td>';
                    echo '<p class="text-xs text-secondary mb-0">' . $courseId . '</p>';
                    echo '</td>';
                    echo '<td>';
                    ...
                    echo '<td>';
                    echo '<div class="d-flex px-2 py-1">';
                    echo '<p class="text-xs text-secondary mb-0">' . $degreename . '</p>';
                    echo '</div>';
                    echo '</td>';
                    echo '<td>';
                    echo '<div class="d-flex px-9 py-1">';
                    echo '<a href="' . $lecturePath . '" target="_blank">View Course Details</a>';
                    echo '</div>';
                    echo '</td>';
                    echo '<td class="align-right">';
                    echo '<a href="javascript:;" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user" onclick="editCourse(' . $courseId . ')">';
