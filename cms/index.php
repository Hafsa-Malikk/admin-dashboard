          ...
          <div class="col-xl-9 col-md-12">
            <div class="slider-content slider-content-2">
              ...
              <button class="theme-btn" data-animation="fadeInUp" data-delay=".6s">
                <a href="./signup.php"><span class="btn-text">SignUp Now</span></a>
              </button>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-xl-7 col-lg-7">
          <div class="about-title-section mb-30">
            <h1>Welcome To Our AridEduToolKit</h1>
            <p>
      ...
      <div class="courses-list">
        <div class="row courses-active">
          <div class="col-xl-12">
            <div class="courses-wrapper course-radius-none mb-30">
              <div class="courses-thumb">
                <a href="course_01.php"><img src="img/courses/single_courses_thumb_01.jpg" alt="" /></a>
              </div>
          ...
          <div class="col-xl-12">
            <div class="courses-wrapper course-radius-none mb-30">
              <div class="courses-thumb">
                <a href="course_01.php"><img src="img/courses/single_courses_thumb_02.jpg" alt="" /></a>
              </div>
              <div class="courses-author">
                <img src="img/courses/coursesauthor1.png" alt="" />
              </div>
          ...
          <div class="col-xl-12">
            <div class="courses-wrapper course-radius-none mb-30">
              <div class="courses-thumb">
                <a href="course_01.php"><img src="img/courses/single_courses_thumb_03.jpg" alt="" /></a>
              </div>
              <div class="courses-author">
                <img src="img/courses/coursesauthor1.png" alt="" />
              </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xl-6 offset-xl-3 col-md-8 offset-md-2">
          <div class="section-title mb-50 text-center">
            ...
            <div class="section-title-para">
              <p class="gray-color">
                Stay informed with our latest news about the university, where we share updates, achievements, and important announcements that showcase the vibrant and dynamic academic environment here.
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-xl-4 col-lg-4 col-md-6">
          <div class="blog-wrapper mb-30">
            <div class="blog-thumb mb-25">
              <a href="news_details.php"><img src="img/blog/blog_thumb_1.jpg" alt="" /></a>
            ...
            <div class="blog-content">
              ...
              <h5>
                <a href="news_details.php">Some say education is the process of gaining information is
                  nation.</a>
              </h5>
              <p>
                Belis nisl adipiscing sapien sed malesu diame lacus eget erat
                Cras mollis scele.
              </p>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6">
          <div class="blog-wrapper mb-30">
            <div class="blog-thumb mb-25">
              <a href="news_details.php"><img src="img/blog/blog_thumb_2.jpg" alt="" /></a>
              <span class="blog-category">news</span>
            </div>
            <div class="blog-content">
              <div class="blog-meta">
              ...
              <h5>
                <a href="news_details.php">Education gives us a knowledge of the world around us and
                  changes
                </a>
              </h5>
              <p>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6">
          <div class="blog-wrapper mb-30">
            <div class="blog-thumb mb-25">
              <a href="news_details.php"><img src="img/blog/blog_thumb_3.jpg" alt="" /></a>
              <span class="blog-category">news</span>
            </div>
            <div class="blog-content">
              <div class="blog-meta">
              ...
              <h5>
                <a href="news_details.php">One thing I wish I can do is, to provide education for all
                  child left behind
                </a>
              </h5>
              <p>
